<template>
  <div id="schoolRollleaderbatch" v-loading.lock="formSubmited" element-loading-text="数据导入中...">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <el-form method="post" action="/schadmin/import/importScore" enctype="multipart/form-data" id="importScoreForm">
            <ol>
              <li class="xiazai">
                ...
                <p style="margin-top:15px;margin-left: 36px;">点击下载导入模板&nbsp&nbsp&nbsp<a :href="baseURLPage+'downloads/参测校长基本信息表.xls'" target="_blank"><el-button type="primary" class="download">下载</el-button></a></p>
              </li>
        ...
        <el-tab-pane label="操作指引" name="two">
          ...
          <div class="explain">
            ...
            <p class="son-remark">2、在“职务”一栏中，若填“正校长”或者“教学副校长”则在随后一栏中写明相应的“担任校长/副校长总年限”“现任校长/副校长年限”。</p>
            ...
            <p class="son-remark">4、请严格按照示例格式填写基础信息。</p>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm: function(e) {
        ...
        $.ajax({
          url:this.staticResources+'/schoolProvider/importTeacher?type=headmaster&schoolId='+that.userInfo.schools.schoolId,
          type:"post",
          data:formData,
